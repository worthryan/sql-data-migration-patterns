--This section returns the highest dose of the antigen that is required
-- and then sorts out the issue with the double counting of the antigens where they are given
-- out of schedule
